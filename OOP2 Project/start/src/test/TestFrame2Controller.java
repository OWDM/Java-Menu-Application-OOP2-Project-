 ...
 * @author owd1
 */
public class TestFrame2Controller  {
    ...
    public void Frame3open(ActionEvent event) throws IOException{
        ...
        {      
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/resurce/TestFrame3.fxml"));
            Parent parent = loader.load();
            TestFrame3Controller open = loader.getController();

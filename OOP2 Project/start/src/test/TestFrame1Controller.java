...
public class TestFrame1Controller {
    ...
    public void signup(ActionEvent event) throws IOException{
        ...
        else
        {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/resurce/TestFrame2.fxml"));
            Parent parent = loader.load();
            
            TestFrame2Controller f = loader.getController();
            f.dis2(username);
            f.dis(tabelnumber);
